...
demo = User.create(first_name: 'Demo', last_name: 'User', email: 'demo@socialnetwork.com', password: 'password', biography: 'just testing things out', birthday: 'January 1st 2011')
user1 = User.create(first_name: 'Yao', last_name:'Xu', email: 'yao@sn.com', password: 'password', biography: 'I AM DEV', birthday: 'January 1st 2011')
...
friend3 = Friend.create!(user_id: user1.id, friend_id: user4.id)
friend4 = Friend.create!(user_id: user1.id, friend_id: user5.id)
friend5 = Friend.create!(user_id: user2.id, friend_id: user3.id)
friend6 = Friend.create!(user_id: user2.id, friend_id: user4.id)
friend7 = Friend.create!(user_id: user3.id, friend_id: user4.id)
friend8 = Friend.create!(user_id: user3.id, friend_id: user5.id)
friend9 = Friend.create!(user_id: user4.id, friend_id: user5.id)
friend10 = Friend.create!(user_id: user4.id, friend_id: user6.id)
friend11 = Friend.create!(user_id: user5.id, friend_id: user6.id)
friend12 = Friend.create!(user_id: user5.id, friend_id: user7.id)
...
friend0 = Friend.create!(user_id: demo.id, friend_id: user1.id)